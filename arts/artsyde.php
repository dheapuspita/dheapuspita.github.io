...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="artsydestyle.css"> 
    ...
    <body>
        <section class="animat">
            ...
            <header>
                ...
                <div>
                    <img src="pic/painting.png" class="feature-img">
                </div>
            <footer>
    ...
    <script>
        ...
        icon.onclick = function(){
            ...
            if(document.body.classList.contains("dark")){
                icon.src = "pic/yellow.png";
            }else{
                icon.src = "pic/black.png";
            }
        }
    </script>
    </body>
